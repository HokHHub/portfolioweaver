        ...
        <>
            <footer className={s.footer}>
                <div className={s.footerLinks}>
                    ...
                    <div className={s.footerLinks__amedia}>
