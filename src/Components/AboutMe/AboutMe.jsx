...
/`)
    ...
    useEffect(()=>{
        ...
        if(gitData.length === 0){
            console.log('no');
        } else if(gitData.length !== 0){
            for(let el of gitData){
                DATA.push(el.id)
            }
            ...
            //         const response = await fetch(`https://api.github.com/gists/${el.id}`);
            //         const tdata = await response.json();
            //         setSnippetContent(snippetContent.push(tdata))
                                        ...
                                        <article className={st.snippet} key={i}>
                                            ...
                                            <div className={st.snippet__code}>
                                                <pre>
                                                    <code>
                                                        {
                                                            snippetContent.length >= 2 ? snippetContent.map((el, i)=>{
